...
public class Decision {
	...
	public void batallaTutorial(Personaje earth, Jugador jugador, Aliado moon, Aliado mercury, Aliado mars, Aliado jupiter, Aliado venus, Enemigo enemigo, boolean victoria) {
		if (victoria) {
			JOptionPane.showMessageDialog(null, "Luna: Su elección fue satisfactoria, por lo que pudiste atacar al enemigo.\nEsto lo debilita, haciendo más fácil derrotarlo o salvarlo.", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("luna.png")));
			JOptionPane.showMessageDialog(null, "Tuxedo Mask:\nEs el fin.", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("tmask.png")));
			JOptionPane.showMessageDialog(null, enemigo.getNombre() + ":\nTienes razón. Es el fin,\npero no para mí.", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("darkmoon.png")));			
		} else {
			JOptionPane.showMessageDialog(null, "Luna: Su elección no fue satisfactoria, por lo que no pudiste atacar al enemigo.\nAnaliza al enemigo y el poder de cada Sailor Guerrera\npara tomar la mejor decisión y debilitar al enemigo.", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("luna.png")));
			JOptionPane.showMessageDialog(null, enemigo.getNombre() + ":\nAhora es demasiado tarde...", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("darkmoon.png")));
		}
	}
	...
	public boolean Decision1(Jugador jugador, Aliado moon, Aliado mercury, Aliado mars, Aliado jupiter, Aliado venus) {
		String[] respuesta = {"Todo bien, no te preocupes.", "¡Ten más cuidado!"};
		 ...
		 int opcion = JOptionPane.showOptionDialog(
		        ...
		        if (opcion == 0) {
		        	jupiter.modAfinidad(true);
		        	JOptionPane.showMessageDialog(null, jupiter.getNombre() + ":\nAh, me alegro. Estaba distraída…", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("makogd.png")));
		        	return true;
		        } else {
		        	jupiter.modAfinidad(false);
		        	JOptionPane.showMessageDialog(null, jupiter.getNombre() + ":\nTampoco es para tanto. Estaba distraída…", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("makobd.png")));
		        	return false;
		        }
	...
	public void tutorialDecision(Jugador jugador, Aliado moon, Aliado mercury, Aliado mars, Aliado jupiter, Aliado venus, String icoPlayer) {
		JOptionPane.showMessageDialog(null, "Tutorial:\nAcabas de tomar una decisión.\nVea los íconos en la parte superior de la pantalla.\nTe señalan si tus elecciones fueron"
				...
				"Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource(icoPlayer)));
		JOptionPane.showMessageDialog(null, venus.getNombre() + ":\nEso es lo que pasa cuando miras a los chicos.", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("Mina.png")));
		JOptionPane.showMessageDialog(null, jupiter.getNombre() + ":\nEs qué es exactamente mi tipo favorito...", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("Mako.png")));
		JOptionPane.showMessageDialog(null, venus.getNombre() + ":\nMako, siempre dices eso...\nAh, por cierto, ¿cómo te llamas?", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("Mina.png")));
	}
	...
	public boolean Decision2(Jugador jugador, Aliado moon, Aliado mercury, Aliado mars, Aliado jupiter, Aliado venus) {	
		String[] respuesta = {"¡Me encantaría!", "Sería genial, pero…"};
		 ...
		 int opcion = JOptionPane.showOptionDialog(
		        ...
		        if (opcion == 0) {
		        	venus.modAfinidad(true);
		        	JOptionPane.showMessageDialog(null, venus.getNombre() + ":\n¡Entonces vámonos!\nNuestros amigos ya nos están esperando.", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("minagd.png")));
		            return true;
		        } else {
		        	venus.modAfinidad(false);
		        	JOptionPane.showMessageDialog(null, venus.getNombre() + ":\nOh, ya debes tener otros planes.\nTodo bien entonces. ¡Nos vemos por ahí!", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("minabd.png")));
		            return false;
		        }
		...
		String[] respuesta = {"Busca alguna manera de ayudar.", "Mejor no involucrarse, no hay nada que hacer."};
		 ...
		 int opcion = JOptionPane.showOptionDialog(
		        ...
		        if (opcion == 0) {
		        	...
		        	JOptionPane.showMessageDialog(null, "Recoges una piedra para arrojarla al enemigo, pero antes de que puedas hacerlo,\nuna rosa roja cruza el cielo y golpea a Nyx, provocando que libere a Sailor Moon.\nTe das cuenta de que acaba de aparecer un joven con esmoquin y máscara.", "Karma: " + jugador.getKarma() + " | Afinidad: ☽" + moon.getAfinidad() + " ☿" + mercury.getAfinidad() + " ♂" + mars.getAfinidad() + " ♃" + jupiter.getAfinidad() + " ♀" + venus.getAfinidad(),  JOptionPane.PLAIN_MESSAGE, new ImageIcon(Decision.class.getResource("tmaskfight.png")));
		        } else {
